...
const ALIASES = {
  ...
  // Firebase（EXTRA_ICONS で追加されるインラインアイコン）
...
/**
 * 参考アセット（参考/フォルダ）に存在しない追加アイコン。
 * SVGをインラインで保持し、ビルド時に services / svgMap へ合流させる。
 * 出典: Firebase 公式ロゴマーク（gilbarbara/logos 収録版）
 */
const EXTRA_ICONS = [
  {
    id: 'gcp-firebase',
    ...
    category: 'Other',
    color: GCP_COLOR,
    svg: '<svg width="256px" height="322px" viewBox="0 0 256 322" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid"><g><path d="M80.1808323,312.295406 C93.6347594,317.709494 108.230746,320.923389 123.556401,321.458215 C144.297625,322.182288 164.021033,317.893803 181.653847,309.747987 C160.509281,301.440899 141.3597,289.292936 125.016395,274.187794 C114.42239,291.15084 98.7532944,304.547829 80.1808323,312.295406 Z" fill="#FF9100"></path><path d="M125.013433,274.192731 C87.706415,239.689026 65.0743742,189.749411 66.9870778,134.974635 C67.0492822,133.195885 67.1430825,131.418287 67.2528453,129.641182 C60.5713009,127.913117 53.5958488,126.858604 46.4173273,126.607977 C36.142079,126.249067 26.1913468,127.523435 16.7969986,130.168933 C6.83803832,147.614145 0.828169967,167.630638 0.0794789059,189.06977 C-1.85272527,244.402081 31.6316004,292.748737 80.1778702,312.300343 C98.7503322,304.552766 114.418934,291.170588 125.013433,274.192731 Z" fill="#FFC400"></path><path d="M125.014914,274.191086 C133.688645,260.310285 138.947716,244.036753 139.559886,226.504323 C141.170454,180.38419 110.16583,140.710278 67.2544909,129.639372 C67.1447281,131.416477 67.0507632,133.194075 66.9887234,134.972825 C65.0758552,189.747765 87.7078961,239.687381 125.014914,274.191086 Z" fill="#FF9100"></path><path d="M134.761095,0 C110.321506,19.5791862 91.0226675,45.3959945 79.3465032,75.1362889 C72.6616676,92.1712486 68.4608946,110.46955 67.2344144,129.650727 C110.145918,140.721632 141.150542,180.395709 139.539974,226.515842 C138.927639,244.048273 133.653264,260.305348 124.995002,274.202605 C141.337814,289.322557 160.487888,301.45571 181.632454,309.762797 C224.072981,290.145367 254.184527,247.930289 255.928884,197.998901 C257.057779,165.647667 244.628415,136.815425 227.064718,112.478029 C208.51694,86.738894 134.761095,0 134.761095,0 Z" fill="#DD2C00"></path></g></svg>',
  },
];
...
async function main() {
  ...
  // インライン追加アイコン（参考アセット外）を合流
  for (const { svg, ...entry } of EXTRA_ICONS) {
    svgMap[entry.id] = minifySvg(svg);
